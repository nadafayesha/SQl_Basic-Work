...
SELECT empid ,fname,lname,deptno,salary from employee
WHERE salary >3000
AND deptno=10;
...
write a query to find the value of N-N1 from station.
   ...
   select Count(city)-Count(distinct city) as "Diffrence between total number of cities" from station;
...
##6. Write a query that prints a list of employee names having a salary greater than $2000 per month who have been employed for less than 10 months.
...
SELECT concat(first_name,' ',last_name) as emp_name from emp where salary>2000 And TIMESTAMPDIFF(MONTH,hire_date,current_date())<10
order by emp_no ASC;
select * from emp;
...
INSERT INTO `city` VALUES (6,'Rotterdam','NLD','Zuid-Holland',593321),(3878,'Scottsdale','USA','Arizona',202705),(3965,'Corona','USA','California',124966),(3973,'Concord','USA','California',121780),(3977,'Cedar Rapids','USA','Iowa',120758),(3982,'Coral Springs','USA','Florida',117549),(4054,'Fairfield','USA','California',92256),(4058,'Boulder','USA','Colorado',91238),(4061,'Fall River','USA','Massachusetts',90555),(1613,'Neyagawa','JPN','Osaka',257315),(1630,'Ageo','JPN','Saitama',209442),(1661,'Sayama','JPN','Saitama',162472),(1681,'Omuta','JPN','Fukuoka',142889),(1739,'Tokuyama','JPN','Yamaguchi',107078);
 select distinct(count(name)) As city_name FROM city WHERE population < 100000;
select* from city;

### 9. What is the total population of California? [table: city]
SELECT sum(population)  As population_california from city where district='california';

###10 What is the average population of the districts in each country? [table: city]
SELECT  distinct(name),(population) As AVG_POPULATION FROM city GROUP BY district;
...
select o.ordernumber, o.status, o.comments, c.customernumber, c.customername
 from orders o 
