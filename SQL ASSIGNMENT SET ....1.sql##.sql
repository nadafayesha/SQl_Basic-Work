...
###3 . Create a table called countries 
CREATE TABLE COUNTRIES(
Country_Name varchar(50) ,
population int,
Capital varcharacter(50) 
...
SELECT* from COUNTRIES;
  ...
  ###3a. Insert the following data into the table
...
###3b) Add a couple of countries of your choice

INSERT INTO COUNTRIES
VALUES ('Argentina', 54,'Buenos Aires' ),
('Bahrain',65,'Manama'),
('Benin',58,'Porto-Novo'),
('China',158,'Beijing');

###3c). Change ‘Delhi' to ‘New Delhi'
...
--Question (a)
Create Table Products(product_id integer Auto_increment primary key ,
Product_name Varchar(200) Unique not null,description varchar(200),
supplier_id Integer,Foreign key(supplier_id) references Suppliers(supplier_id));

##Question (b)
Create Table Suppliers(supplier_id Integer Auto_increment primary key,supplier_name Varchar(70),
location varchar(50));

## Question (c)
Create Table Stock(Id integer Auto_increment primary key,product_id integer,Foreign key(product_id) references Products(product_id),
balance_stock int);

  
 ## 6. Enter some records into the three tables.
INSERT INTO Suppliers(id,Supplier_Name,Location)
values (1,'Daniel','Germany'),
      (2,'John','Washington'),
      (3,'Alexa','London');
...
drop table emp;
   ...
   salary  DECIMAL(8,2) DEFAULT 7850.00
) ;
INSERT INTO  emp  VALUES (10001,'1953-09-02','Georgi','Facello','M','2020-02-23',7850.00),
...
#8a.a.	Add a column called deptno
 ALTER TABLE emp
ADD Deptno Int;
